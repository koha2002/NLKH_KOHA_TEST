...
export default function Page(){const tool:any=fixedTool;if(!tool)notFound();return <><AdminSeoJsonLd route="/tools/quiz"/><AdminToolRoute tool={tool} beforeFrame={<QuizDataPicker/>} importTarget="quiz"/></>}
